export default function Payouts() {
  return (
    <div className="space-y-6">
      ...
      <div className="bg-gradient-to-br from-slate-900 to-brand-900 p-8 rounded-3xl shadow-lg text-white">
      ...
      <div className="bg-white dark:bg-dark-card rounded-3xl border border-slate-200 dark:border-slate-800 overflow-hidden shadow-sm">
        <table className="w-full text-left text-sm">
            ...
            <tbody>
                <tr>
                  <td colSpan={4} className="p-8 text-center text-slate-500">Belum ada riwayat transaksi.</td>
                </tr>
            </tbody>
        </table>
      </div>
