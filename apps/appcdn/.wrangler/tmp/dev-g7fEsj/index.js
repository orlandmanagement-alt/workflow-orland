...
// .wrangler/tmp/bundle-KxLjLA/checked-fetch.js
...
// .wrangler/tmp/bundle-KxLjLA/strip-cf-connecting-ip-header.js
...
var requireAuth = /* @__PURE__ */ __name(async (c, next) => {
  ...
  try {
    ...
    const payload = await verify2(token, c.env.JWT_SECRET || "orland-rahasia-utama-123", "HS256");
...
// .wrangler/tmp/bundle-KxLjLA/middleware-insertion-facade.js
...
// .wrangler/tmp/bundle-KxLjLA/middleware-loader.entry.ts
