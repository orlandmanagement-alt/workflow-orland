  ...
  if (purpose === 'activation') {
      ...
      <div style="font-family: 'Helvetica Neue', Helvetica, Arial, sans-serif; max-width: 600px; margin: 0 auto; border: 1px solid #e2e8f0; border-radius: 12px; overflow: hidden;">
        ...
        <div style="padding: 40px; color: #334155; line-height: 1.6;">
          ...
          <div style="text-align: center; margin: 35px 0;">
            <a href="https://sso.orlandmanagement.com/?activation_token=${token}" 
    ...
    html = `
      <div style="font-family: sans-serif; padding: 20px; border: 1px solid #eee; border-radius: 10px;">
        ...
        <a href="https://sso.orlandmanagement.com/?reset_token=${token}" style="display:inline-block; padding:12px 25px; background:#ef4444; color:white; text-decoration:none; border-radius:5px; font-weight:bold;">Atur Ulang Sandi</a>
      </div>`;
  } else {
